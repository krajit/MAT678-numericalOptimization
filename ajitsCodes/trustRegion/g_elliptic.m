...
function [g_r, r]= g_elliptic(g_x, x)
   % r = 10*x(1).^2 + x(2).^2;
   g_tmp_x_00000= g_x(2);
   tmp_x_00000= x(2);
   g_tmp_x_00001= g_x(1);
   tmp_x_00001= x(1);
   g_tmp_elliptic_00000= adimat_g_pow_left(g_tmp_x_00001, tmp_x_00001, 2);
   tmp_elliptic_00000= tmp_x_00001^ 2;
   g_tmp_elliptic_00001= g_tmp_x_00000- g_tmp_elliptic_00000;
   tmp_elliptic_00001= tmp_x_00000- tmp_elliptic_00000;
   g_tmp_elliptic_00002= 2.* tmp_elliptic_00001.^ (2- 1).* g_tmp_elliptic_00001;
   tmp_elliptic_00002= tmp_elliptic_00001.^ 2;
   g_tmp_elliptic_00003= 100* g_tmp_elliptic_00002;
   tmp_elliptic_00003= 100* tmp_elliptic_00002;
   g_tmp_x_00002= g_x(1);
   tmp_x_00002= x(1);
   g_tmp_elliptic_00004= -g_tmp_x_00002+ g_zeros(1);
   tmp_elliptic_00004= 1- tmp_x_00002;
   g_tmp_elliptic_00005= 2.* tmp_elliptic_00004.^ (2- 1).* g_tmp_elliptic_00004;
   tmp_elliptic_00005= tmp_elliptic_00004.^ 2;
   g_r= g_tmp_elliptic_00003+ g_tmp_elliptic_00005;
   r= tmp_elliptic_00003+ tmp_elliptic_00005; 
